        ...
        <>
            <div className='Navbar'>
                <div className='p-1 menu-burger' onClick={() => { setNav(!nav) }}>
                    <img src="https://img.icons8.com/ios-filled/50/menu--v6.png" alt="menu--v6" />
                </div>
                <div className='logo pointer' onClick={() => { setNav(false) }}><Link to='/'><img src={logo} alt="logo Masny Plus" /></Link></div>
                <ul className='menu'>
