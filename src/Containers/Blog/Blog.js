...
const Blog = () => {
    ...
    return (
        <div className='Blog container'>
            <h1 className='mt-5 text-start mb-5'>Actualites Masny Plus</h1>
            <div>
                {dataArticle.map((article, index) => (
                    <div className='div-article mt-3 mb-5' key={article.ID_ARTICLE} >
                        <h3 className='text-center hindenburg'>{article.TITLE_ARTICLE}</h3>
                                    ...
                                    {connected && (
                                        <div>
                                            <form onSubmit={(e) => handleSubmit(e, article.ID_ARTICLE)}>
                                                ...
                                                <button type="submit"
                                                    disabled={!comments[index] || comments[index].trim() === ''}
                                                    className="btn btn-primary radius50">Commenter</button>
                                            </form>
                                            <hr />
                                        </div>
                                    )}
